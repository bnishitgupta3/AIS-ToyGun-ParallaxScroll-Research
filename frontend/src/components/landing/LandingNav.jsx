    ...
    return (
        ...
        >
            ...
            {total > 0 && (
                <span
                    aria-hidden="true"
                    className="absolute -right-0.5 -top-0.5 grid h-[18px] min-w-[18px] place-items-center rounded-full bg-[#DA0213] px-1 font-inter text-[10px] font-bold leading-none text-white"
                >
                    {total > 99 ? "99+" : total}
                </span>
            )}
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 md:gap-3">
                        ...
                        <a
                            ...
                            className="group relative hidden cursor-pointer overflow-hidden rounded-full bg-[#DA0213] px-5 py-2 text-white shadow-[inset_0_-4px_4px_rgba(255,255,255,0.39)] outline outline-1 outline-[#DA0213] -outline-offset-1 transition-all duration-200 hover:brightness-110 md:inline-block"
                        >
                            <span
                                aria-hidden="true"
                ...
                {open && (
                    <div className="mt-3 flex flex-col gap-1 border-t border-black/10 pt-3 md:hidden">
                        ...
                        <a
                            href="#arsenal"
                            onClick={(e) => goSection(e, "#arsenal")}
                            className="mt-2 inline-flex items-center justify-center rounded-full bg-[#DA0213] px-5 py-3 font-inter text-[14px] font-semibold text-white"
                        >
                            Explore the Arsenal
                        </a>
                    </div>
