...
/* Product-page CTA cluster: Buy Now (primary) + Add to Cart (secondary).
   The counter on Add to Cart matches the Arsenal tile pattern — first click
   turns the button into a − N + stepper at the same dimensions so the layout
   doesn't shift. Buy Now opens the shared "checkout coming soon" sheet until
   Shopify is integrated.

   The component takes `accent` so each product page can theme the buttons
   in its own color, and `variant` to switch between the light variant used
   in the SpecsPanel and the dark variant used in the Footer CTA section. */
